...
import { mernStackVideos } from "@/constants/videos/fullstack/mern-stack";
...
const page = () => {
    ...
    const [search, setSearch] = useState<string | undefined | null>("");
      ...
      const jMernStackVideos = JSON.parse(JSON.stringify(mernStackVideos))
  ...
  return (
    <div className="videosPage">
      ...
      <VideoAndMenu videos={jMernStackVideos} search={search} />
