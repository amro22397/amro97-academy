...
<div className="grotesk mx-auto">
      <section className="w-full mx-auto text-black">
        {/* <div className="mx-auto flex flex-row justify-center items-center p-3 pt-0 lg:pt-4">
          ...
          <div className="mb-20 mt-44 hidden w-full flex-col lg:mt-12 lg:flex">
            <Image src={`/whatsapp ad.png`} alt="Hero" width={1000} height={500}
        ...
        {/* Can be used as introductory video for the academy */}
        <div className="invisible mx-auto max-w-6xl p-3 pb-32 lg:visible lg:px-2 hidden">
        ...
        <div className="hidden bg-white text-black">
          ...
          <div className="text-black hidden">
            <div className="max-w-8xl mx-auto flex flex-col px-5 py-48 text-black lg:flex-row">
              ...
              <div className="hidden items-left flex-col pt-16 text-left lg:w-1/2 lg:flex-grow lg:items-start lg:pl-32 lg:pl-48 lg:text-left">
