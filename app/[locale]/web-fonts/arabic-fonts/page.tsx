...
const page = () => {
  ...
  return (
    <div className='mx-8 my-[122px] flex gap-10 flex-col'
    dir='rtl'>

      <h1 className="flex text-5xl" style={{fontFamily: "Readex Pro"}}>الخطوط العربية</h1>

<p className="text-lg mb-1 font-semibold">أدخل على Google Fonts
  اضف الخط التي تريده لقائمة الخطوط التي تريدها - 
...
<div className="w-[700px] mb-2">
      ...
      <CodeBlock code={globalCssFonts} fileName="global.css"
      language="typescript" height="h-[250px]" />
      </div>

      <CodeBlock code={layoutFonts} fileName="app/layout.tsx"
      language="typescript" height="h-[250px]" />
